...
- **Alakazam (Mega)** using _Counter_ (86%)
- **Beedrill (Mega)** using _Bug Bite_ (86%)
...
- **Baxcalibur** using _Ice Fang_ (73%)
...
- **Breloom** using _Force Palm_ (79%)
- **Lucario** using _Force Palm_ (77%)
...
- **Espeon** using _Confusion_ (72%)
- **Hoopa** using _Confusion_ (72%)
...
- **Yveltal** using _Sucker Punch_ (69%)
...
- **Marshadow** using _Counter_ (73%)
- **Breloom** using _Force Palm_ (73%)
- **Lucario** using _Force Palm_ (71%)
...
- **Salamence (Mega)** using _Fire Fang_ (71%)
...
- **Pidgeot (Mega)** using _Air Slash_ (58%)
...
- **Bewear** using _Tackle_ (47%)
- **Zorua (Hisuian)** using _Scratch_ (46%)

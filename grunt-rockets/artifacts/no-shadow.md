...
* **Volcarona** using _Bug Bite_ (80%)
* **Vikavolt** using _Bug Bite_ (77%)
* **Pinsir** using _Bug Bite_ (73%)
...
* **Salamence (Mega)** using _Bite_ (84%)
* **Tyranitar** using _Bite_ (82%)
* **Yveltal** using _Sucker Punch_ (82%)
...
* **Latios (Mega)** using _Dragon Breath_ (82%)
* **Groudon (Primal)** using _Dragon Tail_ (78%)
* **Palkia (Origin)** using _Dragon Tail_ (77%)
...
* **Xurkitree** using _Spark_ (72%)
* **Vikavolt** using _Volt Switch_ (67%)
* **Arcanine** using _Thunder Fang_ (67%)
...
* **Pidgeot (Mega)** using _Gust_ (100%)
* **Rayquaza (Mega)** using _Air Slash_ (100%)
* **Yveltal** using _Gust_ (90%)
* **Tornadus (Therian)** using _Gust_ (86%)
* **Charizard (Mega Y)** using _Air Slash_ (85%)
* **Staraptor** using _Gust_ (84%)
* **Rayquaza** using _Air Slash_ (76%)
...
* **Diancie (Mega)** using _Tackle_ (100%)
* **Ambipom** using _Scratch_ (99%)
* **Rillaboom** using _Scratch_ (95%)
* **Delphox** using _Scratch_ (92%)
* **Ursaluna** using _Tackle_ (87%)
* **Purugly** using _Scratch_ (84%)
* **Bewear** using _Tackle_ (81%)
...
* **Naganadel** using _Poison Jab_ (87%)
* **Sneasler** using _Poison Jab_ (86%)
* **Nihilego** using _Poison Jab_ (83%)
* **Roserade** using _Poison Jab_ (81%)
* **Revavroom** using _Poison Jab_ (77%)
* **Salazzle** using _Poison Jab_ (76%)
...
* **Tyranitar (Mega)** using _Smack Down_ (83%)
* **Rampardos** using _Smack Down_ (80%)
* **Terrakion** using _Smack Down_ (71%)
* **Lycanroc (Dusk)** using _Rock Throw_ (70%)
* **Lycanroc (Midday)** using _Rock Throw_ (69%)
...
* **Tyranitar (Mega)** using _Iron Tail_ (92%)
* **Archeops** using _Steel Wing_ (92%)
* **Aerodactyl (Mega)** using _Steel Wing_ (92%)
* **Scizor (Mega)** using _Bullet Punch_ (90%)
* **Aggron (Mega)** using _Iron Tail_ (90%)
* **Pidgeot (Mega)** using _Steel Wing_ (88%)
...
* **Gyarados (Mega)** using _Waterfall_ (83%)
* **Kyogre** using _Waterfall_ (77%)
* **Sharpedo** using _Waterfall_ (70%)
* **Gyarados** using _Waterfall_ (69%)
* **Primarina** using _Waterfall_ (67%)
* **Crawdaunt** using _Waterfall_ (65%)
...
* **Palkia (Origin)** using _Dragon Tail_ (100%)
* **Haxorus** using _Dragon Tail_ (99%)
* **Rayquaza** using _Dragon Tail_ (99%)
* **Palkia** using _Dragon Tail_ (98%)
* **Salamence** using _Dragon Tail_ (97%)
...
* **Regigigas** using _Hidden Power (Bug)_ (76%)
...
* **Yveltal** using _Sucker Punch_ (98%)
* **Thundurus (Therian)** using _Bite_ (95%)
* **Sharpedo** using _Bite_ (95%)
* **Zarude** using _Bite_ (95%)
...
* **Palkia** using _Dragon Tail_ (98%)
* **Salamence** using _Dragon Tail_ (97%)
* **Dragapult** using _Dragon Tail_ (93%)
* **Dragonite** using _Dragon Tail_ (92%)


Highest **electric** (⚡) fast move damage: 


* **Thundurus (Therian)** using _Volt Switch_ (100%)
* **Manectric** using _Thunder Fang_ (99%)
* **Xurkitree** using _Spark_ (93%)
* **Vikavolt** using _Volt Switch_ (87%)
* **Arcanine** using _Thunder Fang_ (87%)
* **Regieleki** using _Volt Switch_ (85%)
* **Tapu Koko** using _Volt Switch_ (85%)
...
* **Yveltal** using _Gust_ (100%)
* **Tornadus (Therian)** using _Gust_ (95%)
* **Staraptor** using _Gust_ (94%)
* **Rayquaza** using _Air Slash_ (85%)
* **Kartana** using _Air Slash_ (80%)
* **Tornadus (Incarnate)** using _Air Slash_ (80%)
* **Shaymin (Sky)** using _Hidden Power (Flying)_ (78%)
...
* **Kyurem** using _Steel Wing_ (85%)
* **Regigigas** using _Hidden Power (Steel)_ (84%)
...
* **Kyogre** using _Waterfall_ (100%)
* **Sharpedo** using _Waterfall_ (90%)
* **Gyarados** using _Waterfall_ (88%)
* **Primarina** using _Waterfall_ (87%)
* **Crawdaunt** using _Waterfall_ (84%)
* **Floatzel** using _Waterfall_ (83%)
* **Kabutops** using _Waterfall_ (82%)